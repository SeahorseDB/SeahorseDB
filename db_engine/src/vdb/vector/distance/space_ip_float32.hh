...
/*
 * Inner Product Distance (float32)
 *
 ...
 */
static float InnerProduct(const void *pVect1v, const void *pVect2v,
...
static float InnerProductDistance(const void *pVect1v, const void *pVect2v,
                                  const void *params_ptr) {
  return 1.0f - InnerProduct(pVect1v, pVect2v, params_ptr);
}
...
static float InnerProductDistanceSIMD4ExtAVX(const void *pVect1v,
                                             const void *pVect2v,
                                             const void *params_ptr) {
  return 1.0f - InnerProductSIMD4ExtAVX(pVect1v, pVect2v, params_ptr);
}
...
static float InnerProductDistanceSIMD4ExtSSE(const void *pVect1v,
                                             const void *pVect2v,
                                             const void *params_ptr) {
  return 1.0f - InnerProductSIMD4ExtSSE(pVect1v, pVect2v, params_ptr);
}
...
static float InnerProductDistanceSIMD16ExtAVX512(const void *pVect1v,
                                                 const void *pVect2v,
                                                 const void *params_ptr) {
  return 1.0f - InnerProductSIMD16ExtAVX512(pVect1v, pVect2v, params_ptr);
}
...
static float InnerProductDistanceSIMD16ExtAVX(const void *pVect1v,
                                              const void *pVect2v,
                                              const void *params_ptr) {
  return 1.0f - InnerProductSIMD16ExtAVX(pVect1v, pVect2v, params_ptr);
}
...
static float InnerProductDistanceSIMD16ExtSSE(const void *pVect1v,
                                              const void *pVect2v,
                                              const void *params_ptr) {
  return 1.0f - InnerProductSIMD16ExtSSE(pVect1v, pVect2v, params_ptr);
}

#endif

#if defined(USE_SSE) || defined(USE_AVX) || defined(USE_AVX512)
static DISTFUNC_FLOAT32 InnerProductSIMD16Ext = InnerProductSIMD16ExtSSE;
static DISTFUNC_FLOAT32 InnerProductSIMD4Ext = InnerProductSIMD4ExtSSE;
static DISTFUNC_FLOAT32 InnerProductDistanceSIMD16Ext =
    InnerProductDistanceSIMD16ExtSSE;
static DISTFUNC_FLOAT32 InnerProductDistanceSIMD4Ext =
...
class InnerProductSpaceFloat32 : public SpaceInterface {
  DISTFUNC_FLOAT32 fstdistfunc_;
  size_t data_size_;
  size_t dim_;

 public:
  InnerProductSpaceFloat32(size_t dim) {
