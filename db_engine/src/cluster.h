...
static_assert_(sizeof(clusterMsgPingExtForgottenNode) % 8 == 0, "");
...
static_assert_(offsetof(clusterMsg, sig) == 0, "unexpected field offset");
static_assert_(offsetof(clusterMsg, totlen) == 4, "unexpected field offset");
static_assert_(offsetof(clusterMsg, ver) == 8, "unexpected field offset");
static_assert_(offsetof(clusterMsg, port) == 10, "unexpected field offset");
static_assert_(offsetof(clusterMsg, type) == 12, "unexpected field offset");
static_assert_(offsetof(clusterMsg, count) == 14, "unexpected field offset");
static_assert_(offsetof(clusterMsg, currentEpoch) == 16, "unexpected field offset");
static_assert_(offsetof(clusterMsg, configEpoch) == 24, "unexpected field offset");
static_assert_(offsetof(clusterMsg, offset) == 32, "unexpected field offset");
static_assert_(offsetof(clusterMsg, sender) == 40, "unexpected field offset");
static_assert_(offsetof(clusterMsg, myslots) == 80, "unexpected field offset");
static_assert_(offsetof(clusterMsg, slaveof) == 2128, "unexpected field offset");
static_assert_(offsetof(clusterMsg, myip) == 2168, "unexpected field offset");
static_assert_(offsetof(clusterMsg, extensions) == 2214, "unexpected field offset");
static_assert_(offsetof(clusterMsg, notused1) == 2216, "unexpected field offset");
static_assert_(offsetof(clusterMsg, pport) == 2246, "unexpected field offset");
static_assert_(offsetof(clusterMsg, cport) == 2248, "unexpected field offset");
static_assert_(offsetof(clusterMsg, flags) == 2250, "unexpected field offset");
static_assert_(offsetof(clusterMsg, state) == 2252, "unexpected field offset");
static_assert_(offsetof(clusterMsg, mflags) == 2253, "unexpected field offset");
static_assert_(offsetof(clusterMsg, data) == 2256, "unexpected field offset");
